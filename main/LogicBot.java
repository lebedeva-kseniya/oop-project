    ...
    public String handleUserAnswer(String answer){
        ...
        switch (answer){
            case "/help":
                ...
                result.append("ПОДСКАЗКИ:\n/hint - информация о доступных подсказках\n/hint.random - показывает букву на случайной, ранее не открытой позиции\n/hint.letter - выводит 2 случайные буквы из слова\n");
